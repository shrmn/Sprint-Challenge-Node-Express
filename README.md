...
>Middleware is an array of functions which add features, executed in the order they are added to the server code.

- [x] Describe a Resource?

>Everything is a resource. Just kidding. A resource is an object with a type, associated data, relationships to other resources, and a set of methods that operate on it.

- [x] What can the API return to help clients know if a request was successful?

>Status 200, plus a useful message or piece of data (e.g. a copy of the specific user added or a list of all users including the newly added user).

- [x] How can we partition our application into sub-applications?

>You can use express.Router separate endpoints.
